...
public class Indexer {
    ...
    public void index() throws CorruptIndexException,
        ...
        Directory dir = FSDirectory.open(indexDirectory); //this directory will contain indexes
        Analyzer analyzer = new StandardAnalyzer(StandardAnalyzer.STOP_WORDS_SET); //using stop words
        IndexWriterConfig iwc = new IndexWriterConfig(Version.LUCENE_4_10_2, analyzer);    // create the indexer
